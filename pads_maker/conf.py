...
#
html_title = "PADS Maker Cheat Sheet"
html_theme = 'epub'
...
htmlhelp_basename = 'PADSMakerdoc'
...
latex_documents = [
    (master_doc, 'padsmaker.tex', u'PADS Maker Cheat Sheet',
...
man_pages = [
    (master_doc, 'padsmaker', u'PADS Maker Cheat Sheet',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'padsmaker', u'PADS Maker Cheat Sheet',
     author, 'padsmaker', 'One line description of project.',
     'Miscellaneous'),
]
