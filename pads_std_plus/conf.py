# -*- coding: utf-8 -*-
#
# PADS Std Plus documentation build configuration file, created by
...
htmlhelp_basename = 'PADSStdPlusdoc'
...
latex_documents = [
    (master_doc, 'PADSStdPlus.tex', u'PADS Std Plus Documentation',
...
man_pages = [
    (master_doc, 'padsstdplus', u'PADS Std Plus Documentation',
     [author], 1)
]
